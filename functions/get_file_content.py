...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Outputs the contents of a file , constrained to the working directory. Truncates file to 1000 characters if necessary",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="A file path to retrieve file contents from, relative to the working directory.",
            ),
        },
    ),
)